        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 my-8 space-y-4">
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <button
                    ...
                    disabled={isLocating}
                    className={`flex-shrink-0 w-full md:w-auto flex items-center justify-center gap-2 px-4 py-3 rounded-lg border-2 transition-colors disabled:opacity-50 ${
                        sortByDistance
                ...
                >
                 ...
                 <button
                    ...
                    className={`flex-shrink-0 w-full md:w-auto flex items-center justify-center gap-2 px-4 py-3 rounded-lg border-2 transition-colors ${
                        showSavedOnly
