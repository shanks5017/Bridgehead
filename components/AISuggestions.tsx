...
// Removed Google GenAI types as we now use Groq backend wrapper
...
const AISuggestions: React.FC<AISuggestionsProps> = ({ demands }) => {
    ...
    const GroundingSources: React.FC<{ chunks: any[] | undefined }> = ({ chunks }) => {
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {isLoading && !response ? (
                    ...
                    <div className="w-full max-w-4xl mx-auto bg-[--card-color] border border-[--border-color] rounded-xl p-8">
                        ...
                        />
                        {/* Grounding sources momentarily disabled until backend support added */}
