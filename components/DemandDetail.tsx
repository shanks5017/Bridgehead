...
import { ArrowLeftIcon, LocationPinIcon, UpvoteIcon, ChatBubbleLeftRightIcon, PhoneIcon } from './icons';
...
const DemandDetail: React.FC<DemandDetailProps> = ({ post, onBack, onImageClick, onStartCollaboration }) => {
