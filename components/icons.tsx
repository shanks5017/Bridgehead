...
export const BriefcaseIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.106-1.968 2.106H5.719c-1.181 0-1.969-1.012-1.969-2.106v-4.25m16.5 0a3.004 3.004 0 00-2.5-2.916M2.5 14.15A3.004 3.004 0 016.969 11.23M2.5 14.15h16.5M6.969 11.23l1.875 5.625a1.5 1.5 0 002.812 0l1.875-5.625m-6.562 0h6.563M7.5 4.125h9a2.25 2.25 0 012.25 2.25v2.25h-13.5v-2.25a2.25 2.25 0 012.25-2.25z" />
    </svg>
);
