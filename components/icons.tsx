...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-15l.01.01M18 7l.01.01M21 12l-1-1M12 21l-1-1M3 12l1 1m15-5l-1 1M12 3l1 1m-4 11h.01M16 16h.01" />
    </svg>
);
...
export const ChatIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path fillRule="evenodd" d="M4.804 21.642A6.5 6.5 0 0010 23c6.075 0 11-3.582 11-8s-4.925-8-11-8S-1 10.582-1 15c0 1.95.83 3.731 2.201 5.086l-1.01 2.83a.5.5 0 00.588.626l3.025-1.9zM10 21a4.5 4.5 0 110-9 4.5 4.5 0 010 9z" clipRule="evenodd" />
    </svg>
);
...
export const HeartIcon: React.FC<IconProps> = ({ className, isFilled }) => (
...
export const BookmarkIcon: React.FC<IconProps> = ({ className, isFilled }) => (
...
export const QuoteIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M14.017 21v-7.391c0-2.725.99-4.828 3.522-6.104l.447-.234-.447-.234c-1.79-1.258-2.228-3.34-2.228-5.037v-1h-4v9h4v-1h-2v-5h2v7h-4v9h4zM4.017 21v-7.391c0-2.725.99-4.828 3.522-6.104l.447-.234-.447-.234c-1.79-1.258-2.228-3.34-2.228-5.037v-1h-4v9h4v-1h-2v-5h2v7h-4v9h4z" />
    </svg>
);
...
export const XSocialIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M6 12a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75H6.75a.75.75 0 01-.75-.75V12zm2.25 0a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75H9a.75.75 0 01-.75-.75V12zm2.25 0a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75H12a.75.75 0 01-.75-.75V12z" />
    </svg>
);
...
export const PhoneIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.211-.992-.58-1.353l-2.12-2.12a1.5 1.5 0 00-2.12 0l-1.214 1.213a11.25 11.25 0 01-5.63-5.63l1.213-1.214a1.5 1.5 0 000-2.12l-2.12-2.12A1.5 1.5 0 006.33 3.442H5.006A2.25 2.25 0 002.25 5.625v1.125z" />
    </svg>
);
...
export const VerifiedIcon: React.FC<IconProps & { title?: string }> = ({ className, title }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export const CameraIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M1 8a2 2 0 012-2h.586a2 2 0 001.414-.586l.707-.707A2 2 0 016.414 4h7.172a2 2 0 011.414.586l.707.707A2 2 0 0017.414 6H18a2 2 0 012 2v8a2 2 0 01-2 2H2a2 2 0 01-2-2V8zm13.5 4a3.5 3.5 0 11-7 0 3.5 3.5 0 017 0z" clipRule="evenodd" />
    </svg>
);
...
export const MicrosoftIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" fill="currentColor">
